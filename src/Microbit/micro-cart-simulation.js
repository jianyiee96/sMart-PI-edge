...
input.onButtonPressed(Button.AB, function () {
    if (state == 1) {
        state = 0
        radio.sendString(">" + control.deviceName() + "=A=" + generalItems[generalIndex])
        basic.showLeds(`
            . . . . .
            . . # . .
            . # # # .
        ...
        state = 0
        radio.sendString(">" + control.deviceName() + "=R=" + cartItems[cartIndex])
        basic.showLeds(`
            . . . . .
            . . . . .
            . # # # .
...
radio.setGroup(1)
generalItems = ["C7E671B4", "OA4B997F", "AAAAAAAA", "BBBBBBBB", "CCCCCCCC", "DDDDDDDD"]
